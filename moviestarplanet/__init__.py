...
from pyamf import ASObject, remoting
...
class AsyncClient():
    ...
    async def login_async(self, username: str, password: str, server: str, use_socket: Optional[bool]=True, proxy: Optional[str]=None,session=None):
